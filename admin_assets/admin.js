...
function renderSection(section) {
  const map = { overview: renderOverview, users: renderUsers, payments: renderPayments, activity: renderActivity, images: renderImages, plans: renderPlans, topups: renderTopupPlans, broadcast: renderBroadcast, methods: renderMethods, settings: renderSettings };
  map[section]();
}
